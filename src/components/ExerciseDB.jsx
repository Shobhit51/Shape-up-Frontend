...
const ExerciseDB = () => {
  ...
  const apiHost = import.meta.env.VITE_EXERCISE_API_HOST;
  ...
  const handleSearch = async () => {
    const options = {
      ...
      params: {limit: '10'},
      headers: {
        // 'X-RapidAPI-Key': 'beb9d5ed45msh437650e00fe91ccp11a2d7jsn7e2d7bbdf6b6',
  ...
  return (
    ...
    <div>
        ...
        <br /><br /><br />
        <h2 className="lct">Search For A Perfect Exercise</h2>
      ...
      {currentExercises.length > 0 ? (
        ...
        <h3 className="lct">Exercises and demonstrations will be displayed here.</h3>
      )}
